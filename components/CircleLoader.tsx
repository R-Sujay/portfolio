...
const CircleLoader: React.FC<CircleLoaderProps> = ({
  ...
  const sizeCanvas = (sizePassed * 220) / 64;

  const canvasRef = useRef<HTMLCanvasElement | null>(null);

  useEffect(() => {
    const $ = (s: string, o: Document | HTMLElement = document) =>
      o.querySelector(s) as HTMLElement;
    ...
    camera.rotation.x = THREE.MathUtils.degToRad(60); // Updated to use MathUtils
    ...
    scene.add(new THREE.AmbientLight(ambientLightColor)); // Setup
