      ...
      {projects.map((item, i) => (
        ...
        >
          <div className="flex w-full flex-col items-center justify-between space-y-3 text-center md:absolute md:w-[44%] md:items-start md:py-10 md:text-left">
            ...
            <motion.div
              className="dark:text-darkGrey z-50 h-min w-[95%] rounded-3xl bg-gray-100 py-4 pl-5 pr-2 text-xs text-gray-500 dark:bg-secondary sm:w-[60%] sm:text-sm md:w-[110%] lg:max-h-48 lg:w-[105%] lg:py-5 lg:pl-7 lg:pr-4 lg:text-base xl:max-h-44 xl:w-[100%]"
              viewport={{ once: true }}
            >
